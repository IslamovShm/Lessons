        ...
        <div className={styles.lesson__complete_container}>
            <div className={styles.allEx__wrapper}>
                <div className={styles.done}>
                    <div className={styles.done__progress} style={{width: `${progress}%`}}>
                    </div>
                </div>
